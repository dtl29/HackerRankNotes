...
If the argument sequences are of unequal lengths, then the returned list is truncated to the length of the shortest argument sequence.
    Sample Code
        ...
        [(1, 6, 7), (2, 5, 8), (3, 4, 9)]
Task
    The National University conducts an examination of N
    students in X subjects.
    Your task is to compute the average scores of each student.
        Average Score = Sum scores / total number of subjects
...
Input Format
    ...
    The next X lines contains the space separated marks
    obtained by students in a particular subject.
Constraints
    0<N<=100
    0<C<=100
Output Format
...
Average marks of student 5: 256 / 3 = 85.5
"""
...
#zip only changed list to tuples
##this is not needed for my code to run
a = zip(*a)
