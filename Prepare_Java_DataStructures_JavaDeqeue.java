...
for which elements can be added to or removed from either the front (head)
or back (tail).
...
number of unique integers among all the possible contiguous subarrays of
size M.
...
Constraints
    ...
    1<=M<=100000
    M<=N
    The numbers in the array will range between [0,1000000000].
Output Format
...
Explanation
    ...
    maximum amount of unique numbers among all possible contiguous subarrays
    is 3.
*/
