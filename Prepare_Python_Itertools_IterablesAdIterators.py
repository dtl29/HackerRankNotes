...
integer K, you can select any K indices (assume 1-based indexing)
...
Input Format
    ...
    the integer N, denoting the length of the list. The next
    line consists of N space-separated lowercase English letters,
...
Output Format
    Output a single line consisting of the probability that at
...
Sample Output
    0.8333
Explanation
    All possible unordered tuples of length 2 comprising of
    indices from 1 to 4 are:
    (1,2),(1,3),(1,4),(2,3),(2,4),(3,4)
    Out of these 6 combinations, 5 of them contain either index
    1 or index 2 which are the indices that contain the letter
    'a'.
