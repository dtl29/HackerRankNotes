...
Function Description
  ...
  a reference to the head node of your finished list. insertNodeAtPosition has
...
Constraints
  1<=n<=1000
  1<=SinglyLinkedListNode[i].data<1000, where SinglyLinkedListNode[i] is the ith
...
Sample Output
  16 13 1 7
Explanation
  The initial linked list is16->13->7. Insert 1 at the position 2 which
