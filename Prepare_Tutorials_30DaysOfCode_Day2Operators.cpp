...
/**
Objective
    In this challenge, you will work with arithmetic operators.          Check out the Tutorial tab for learning materials and an             instructional video. https://www.hackerrank.com/challenges/          30-operators/tutorial
Task
...
void solve(double meal_cost, int tip_percent, int tax_percent) {
    double tip = double(tip_percent) * 0.01 * meal_cost;
    double tax = double(tax_percent) * 0.01 * meal_cost;
    //round() rounds a double/float to the nearest int
    cout <<  round(meal_cost + tax + tip);
}
