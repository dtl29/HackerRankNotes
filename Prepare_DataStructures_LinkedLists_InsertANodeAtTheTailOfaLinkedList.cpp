...
Returns
  SinglyLinkedListNode pointer: reference to the head of the modified linked
  list
Input Format
  The first line contains an integer n, the number of elements in the linked
  list.
  The next n lines contain an integer each, the value that needs to be inserted
  at tail.
Constraints
  1<=n<=1000
  1<=list_i<=1000
...
Explanation
  ...
  inserting 474, the list is 141 -> 302 -> 164 -> 530 -> 474 -> NULL, which is
  the final list.
*/
#include <bits/stdc++.h>
