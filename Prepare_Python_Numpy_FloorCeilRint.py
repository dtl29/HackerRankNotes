...
On the second line, print the ciel of A.
...
#import numpy and set the print options to print the rounded number
import numpy
numpy.set_printoptions(legacy='1.13')

#import list, convert list to floats, convert to numpy array
ar = raw_input().split(' ')
ar = list(map(float, ar))
ar = numpy.array(ar)

#print each of the 3 rounding operations 
