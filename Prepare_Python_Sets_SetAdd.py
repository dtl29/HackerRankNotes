...
s = set('')
for i in range(0, n):
    #needs raw input or it will be treated as a var (idk why its not a string)
    strg = raw_input()
    #print(strg)
    #sets dont allow duplicates so adding one by one eleminates dupllicates in input
    s.add(strg)
print (len(s))
