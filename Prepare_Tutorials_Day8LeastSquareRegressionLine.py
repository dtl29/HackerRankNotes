"""
Objective
    In this challenge, we practice using linear regression techniques. Check out the
    Tutorial tab for learning materials!
Task
    ...
    grade, (x, y) can be expressed as the following list of  points:
        1.(95,85)
        2.(85,95)
        3.(80,70)
        4.(70,65)
    ...
    them to achieve in Statistics? Determine the equation of the best-fit line using
...
Input Format
    ...
    describing a student's respective  and  grades:
        95 85
        85 95
        80 70
        70 65
