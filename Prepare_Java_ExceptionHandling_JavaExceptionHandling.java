...
Create a class MyCalculator which consists of a single method long
power(int, int). This method takes two integers, n and p, as parameters and
finds n^p. If either n or p is negative, then the method must throw an exception
which says "n or p should not be negative.". Also, if both  and  are zero, then
the method must throw an exception which says "n and p should not be zero."
...
Output Format
  ...
  If either n or p is negative, the output contains "n and p should be
...
Explanation 0
  ...
  exception, "n or p should not be negative.", is printed for these two cases.
*/
