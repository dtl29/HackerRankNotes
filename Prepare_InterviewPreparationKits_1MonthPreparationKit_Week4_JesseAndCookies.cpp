...
Example
    ...
    Remove them then return 2+2X3=8 to the array. Now A=[8,7,6,4,6].
    Remove 4,6 and return 4+6X2=16 to the array. Now A=[16,8,7,6].
    Remove 6,7, return 6+2X7=20 and A=[20,16,8,7].
    Finally, remove 8,7 and return 7+2X8=23 to A. Now A=[23,20,16].
...
Explanation
    ...
    with resulting sweetness  = 1X3+2X5=13
