...
linear algebra calculations. These can be found in the sub-module 
linalg.
...
linalg.inv
    The linalg.inv tool computes the (multiplicative) inverse of a 
    matrix.
...
Task
    ...
    to find the determinant. Note: Round the answer to 2 places after 
    the decimal.
Input Format
...
NA = numpy.reshape(numpy.array(A), (N,N))
print(round(numpy.linalg.det(NA), 2))