...
He must handle requests which come in the following forms:
  ...
  2 x y : Print the number of pages in the y book on the xth shelf.
...
Input Format
  ...
  requests.
  Each of the following total_nmber_of_queries lines contains a request in one
  of the three specified formats.
Constraints
  1<=total_number_of_shelves <=10^5
  1<=total_number_queries<=10^5
  For each query of the second type, it is guaranteed that a book is present on
  the xth shelf at yth index.
