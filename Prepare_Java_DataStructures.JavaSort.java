...
ID.
Hint: You can use comparators to sort a list of objects. See the oracle
docs* to learn about comparators.
...
Output Format
    After rearranging the students according to the above rules, print the
    first name of each student on a separate line.
Sample Input
    5
    33 Rumpa 3.68
    85 Ashis 3.85
