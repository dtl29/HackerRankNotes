...
Example.
  ...
  The grid is shown below:
    ...
    .X.
    ...
  The starting position  so start in the top left corner. The goal is . The path
  is . It takes  moves to reach the goal.
...
Input Format
  ...
  Each of the next n lines contains a string of lengthn.
  The last line contains four space-separated integers: startX, startY, goalX,
  goalY
Constraints
  1<=n<=100
...
Sample Output
  3
Explanation
  Here is a path that one could follow in order to reach the destination in 3
  steps:
  (0,0)->(2,0)->(2,2)->(0,2).
*/
