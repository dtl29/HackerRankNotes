...
players alphabetically by name. To do this, you must create a Checker class that
implements the Comparator interface, then write an int
...
{
    // Method
    // Sorting in decending order of score number
