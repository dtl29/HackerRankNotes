...
//this was not a binary tree and is wrong
...
Output Format
  Return the a pointer to the node that is the lowest common ancestor of v1
  and v2.
Sample Input
  6
  4 2 3 1 7 6
...
*/
    /*first picture in the problem is not a binary tree. idk if the problem works with
    true binary trees or if it works with the ones on the problem whcih is created not
    in the way binary trees form*/
