...
Example
    ...
    2/5=0.400000, 2/5=0.400000 and 1/5=.2000000. Results are printed as:
        0.400000
        0.400000
        0.200000
...
Explanation
    ...
    The proportions of occurrence are positive:  3/6=0.500000, negative: 2/6=0.3333333
...
void plusMinus(vector<int> arr) {
    ...
    if(arr.size() > 0)
    {
        ...
        cout << double(pos) / double(arr.size()) << "\n"
            << double(neg) / double(arr.size()) << "\n"
            << double(zer) / double(arr.size());
    }
    else {
