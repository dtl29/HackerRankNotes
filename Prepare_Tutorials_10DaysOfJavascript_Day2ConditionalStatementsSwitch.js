...
Task
  ...
  string, s, consisting of lowercase English alphabetic letters (i.e., a through
  z). It must return A, B, C, or D depending on the following criteria:
...
Explanation 0
  ...
  stipulate that we print A any time the first character is in {a,e,i,o,u}, we
  return A as our answer.
*/
