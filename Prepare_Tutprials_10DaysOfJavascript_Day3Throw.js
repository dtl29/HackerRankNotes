/*
Objective
  In this challenge, we practice using throw and catch statements to work with
...
Explanation 1
  ...
  isPositive function:
    ...
    2.isPositive(0): Because a=0, we throw an Error with message= Zero Error.
    This is caught by the locked stub code and the value of its message is
    printed.
...
Explanation 2
  ...
  function:
    ...
    Error. This is caught by the locked stub code and the value of its message
    is printed.
